    ...
    val ROUTE_WALK = SequenceScript(
        ...
        steps = listOf(
            ...
            step(
                ...
                Symbol.LEFT,
                80,
                note = "Under 100 m - the icon should blink",
                text = "SP RING ROAD",
            ),
            ...
            step(
                ...
                Symbol.ROUNDABOUT,
                250,
                note = "Family U - does this draw a roundabout?",
                exit = 2,
                text = "CIRCLE",
            ),
            step(
                "Roundabout N exit 2",
                Symbol.ROUNDABOUT_ALT,
                250,
                note = "Family N - compare against the previous step",
                exit = 2,
                text = "CIRCLE",
            ),
            ...
            step(
                ...
                Symbol.ARRIVE,
                20,
                note = "Arrival uses H, not lowercase g",
                text = "DESTINATION",
                totalM = 20,
            ),
        ),
